        ...
        <div className="card p-6 mb-8">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="mt-1">
                <span className="inline-block px-2 py-1 text-xs rounded-full bg-gray-500 text-white">FREE TRIAL</span>
              </div>
            </div>
            <button onClick={() => router.push('/payment')} className="btn-primary px-4 py-2 rounded-lg">
              {t('upgrade_to_pro')}
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {MENU.map((item) => (
            <div
              ...
              className="card p-4 cursor-pointer transition hover:shadow-lg"
            >
