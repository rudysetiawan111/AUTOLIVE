...
import { Flame, Download, Edit3, Upload, Calendar, Settings, TrendingUp } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="card p-6 mb-8">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div><h2 className="text-2xl font-bold">{t('welcome')}, Admin {userData?.full_name || user?.email?.split('@')[0]}!</h2><p className="text-gray-500">{user?.email}</p><span className="inline-block px-2 py-1 text-xs rounded-full bg-purple-500 text-white">ADMIN</span></div>
          </div>
        </div>
